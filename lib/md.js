...
mdserve.spawnHandler=function(dir,title){
  /*  It would be better if this accepted an object
      but I don't want to break it for anyone already using it (me)
  */
  var opt;
  if(typeof dir === 'object'){
    ...
    opt={
      path:dir
      ,title:title||"" // the default title is 'unmon', a shameless plug.
    };
  }
