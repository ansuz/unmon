...
//    console.log(JSON.stringify({      url:req.url      ,path:path    }));
    ...
    var response=function(path){
      ...
      /* Douglas Crockford strongly recommends against
        using fallthrough behaviour in switches
        I use it here anyway, cause I want to keep this statement small
        You've been warned, watch that if you add cases, they don't fall through
        */
